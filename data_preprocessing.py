...
p = pd.read_csv('complaints-2-28-22.csv')
...
c2.to_csv('panel1-2-28-22.csv', index=False)
...
cd.to_csv('panel2-2-28-22.csv', index=False)
...
lda3.to_csv('map2-2-28-22.csv', index = False)
